...
const enGisTools: MessageTree = {
  ...
  gis: {
    ...
    page: {
      ...
      boundariesReady_one: "{{count}} boundary visible",
      boundariesReady_other: "{{count}} boundaries visible",
      boundariesGuardrail: "Select a safe geography scope before loading deeper boundaries",
      modes: {
        analysis: "Analysis",
    ...
    boundaryExplorer: {
      ...
      parent: "Parent",
      clearParent: "Clear parent boundary",
      loaded: "Loaded",
      loading: "Loading boundaries...",
      error: "Boundary request failed",
      visibleFeatures: "visible features",
      guardrail: "Choose a country or drill down before loading this level.",
      clickBoundary: "Click a boundary to inspect it or drill down.",
    },
    regionDetail: {
      loading: "Loading...",
      close: "Close",
