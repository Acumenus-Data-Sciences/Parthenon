...
const routeHelpKeys: Record<string, string> = {
  ...
  "/admin/honest-broker": "admin.honest-broker",
  "/admin/library": "admin.library",
  "/admin/mapping-review": "admin.mapping-review",
  "/admin/notifications": "admin.notifications",
  "/admin/roles": "admin.roles",
  "/admin/solr": "admin.solr",
  ...
  "/workbench": "workbench",
  "/workbench/care-bundles": "workbench.care-bundles",
  "/workbench/cohorts": "finngen.workbench-sessions",
  "/workbench/finngen-analyses": "finngen.analyses",
  "/workbench/finngen-endpoints": "finngen.endpoints",
