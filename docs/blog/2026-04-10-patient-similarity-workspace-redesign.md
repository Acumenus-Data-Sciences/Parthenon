...
*The design specification that drove this redesign lives at `docs/lineage/design/specs/2026-04-10-patient-similarity-ux-redesign.md`. The 13 new frontend components and backend endpoint changes are in the same commit as this post. At original publication the project used Apache 2.0; current CE releases are AGPL-3.0-only.*
