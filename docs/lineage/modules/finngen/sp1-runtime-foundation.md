...
- Running the A2 role-creation migration requires CREATEROLE privilege which `parthenon_migrator` does not have by design. Use `claude_dev` to run this migration one-time; subsequent migrations run normally under `parthenon_migrator`. Documented in the A2 devlog at `docs/lineage/timeline/sessions/2026/2026-04-13-finngen-sp1-db-roles.md`.
...
Detailed handoff: `docs/lineage/design/specs/2026-04-12-finngen-workbench-subprojects-handoff.md`.
