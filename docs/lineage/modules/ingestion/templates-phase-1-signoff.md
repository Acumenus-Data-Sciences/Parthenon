...
**Spec:** `docs/lineage/design/specs/2026-05-03-parthenon-ingestion-templates-phase-1-design.md`
...
- Devlog narrative:
  `docs/lineage/modules/ingestion/templates-phase-1.md`
- Security review:
  `docs/lineage/modules/ingestion/templates-phase-1-security.md`
- DoD verification:
  `docs/lineage/modules/ingestion/templates-phase-1-dod.md`
