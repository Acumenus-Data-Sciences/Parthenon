...
- [ ] `load_athena_vocabulary` runs end-to-end against a real bundle in
  ...
  - Staging run-id: _(fill at sign-off)_; pack output to be committed under
    `docs/lineage/modules/ingestion/staging-runs/load_athena_vocabulary-<date>.md`.
...
- [x] HIGHSEC §1–§7 review passes.
  - `docs/lineage/modules/ingestion/templates-phase-0-security.md`. Sign-off
...
- [x] Devlog written.
  - `docs/lineage/modules/ingestion/templates-phase-0.md` (Task 19).

- [x] Operations runbook written.
  - `docs/lineage/modules/ingestion/templates-phase-0-runbook.md` (Task 20).
