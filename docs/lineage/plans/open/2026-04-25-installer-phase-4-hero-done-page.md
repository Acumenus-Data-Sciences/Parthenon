...
**Spec reference:** `docs/lineage/design/specs/2026-04-24-installer-first-run-comprehensive-design.md` — Block 1 (Hero Done page) + Area D1–D11 + Area F6 (auto-updater banner UX).
