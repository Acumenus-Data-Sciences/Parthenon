...
5. **Devlog** — `docs/lineage/operations/2026-XX-XX-quarterly-upstream-diff-workflows.md` documents cadence, what humans need to look at when a PR opens, and the failure mode when the upstream extractor itself breaks.
