...
The requirements spec is `docs/lineage/handoffs/2026-04-13-authentik-parthenon-sso-handoff.md`. This plan implements every section of that handoff. When the plan and the handoff disagree, the handoff wins — update the plan.
...
**Docs:**
- `docs/lineage/modules/auth/2026-04-13-authentik-sso.md` — devlog after rollout
