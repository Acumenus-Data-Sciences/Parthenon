...
**Spec reference:** `docs/lineage/design/specs/2026-04-24-installer-first-run-comprehensive-design.md` — Areas A1, B4, E1, F6 plus the Architecture section's "Three new Tauri plugins" subsection.
