...
10. **Devlog + ADR 0016 amendment** — extend ADR 0016 (claims_to_omop) with the streaming companion path. Devlog at `docs/lineage/modules/2026-XX-XX-fhir-bulk-data-streaming-claims.md`.
