...
**Spec reference:** [docs/lineage/design/specs/2026-05-08-ce-ee-fork-and-agplv3-relicense-design.md](../../design/specs/2026-05-08-ce-ee-fork-and-agplv3-relicense-design.md) — Phases 0, 0.5, 1.

**Existing handoff to leverage:** [docs/lineage/handoffs/Apache2.0_to_AGPLv3_Conversion.md](../../handoffs/Apache2.0_to_AGPLv3_Conversion.md) — Workstream A audit findings + recipe.
...
If `sed` touched historical handoffs in `docs/lineage/handoffs/`, revert them:

```bash
git checkout -- docs/lineage/handoffs/2026-03-28-project-vulcan-handoff.md
git checkout -- docs/lineage/handoffs/Apache2.0_to_AGPLv3_Conversion.md
git checkout -- docs/lineage/handoffs/parthenon-acropolis-integration-prompt.md
      ...
      - name: Check for stale org references
        run: |
          ...
          if [ -n "$STALE" ]; then
            ...
            echo "docs/lineage/handoffs/ and docs/devlog/ are excluded automatically."
            exit 1
          fi
...
Historical references in docs/lineage/handoffs/ and docs/devlog/ are intentionally
...
- Historical references in `docs/lineage/handoffs/` and `docs/devlog/` preserved
...
Heritage contributor audit (per docs/lineage/handoffs/Apache2.0_to_AGPLv3_Conversion.md):
...
See `docs/lineage/handoffs/Apache2.0_to_AGPLv3_Conversion.md` §2.2.
EOF
)"
```
