...
- Phase 1 closeout artifacts mirror the structure of Phase 0 closeout (see `docs/lineage/modules/ingestion/templates-phase-0-{security,dod,runbook,signoff}.md`).
...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-1-perf-decision.md`
...
`docs/lineage/modules/ingestion/templates-phase-1-perf-decision.md`:

```markdown
# Phase 1 — fhir_to_omop performance decision (Q6)

**Date:** 2026-05-03
**Spec reference:** `docs/lineage/design/specs/2026-05-03-parthenon-ingestion-templates-phase-1-design.md` §11 Q6
...
```bash
cd /home/smudoshi/Github/Parthenon
git add docs/lineage/modules/ingestion/templates-phase-1-perf-decision.md \
        templates/tests/unit/test_phase_1_perf_decision_doc.py
...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-1-security.md`
...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-1-dod.md`
...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-1.md`
...
**Files:**
- Modify: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-0-runbook.md` (extend with Phase 1 surfaces)
- OR
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-1-runbook.md` (new file referenced from Phase 0 runbook)
...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-1-signoff.md`
