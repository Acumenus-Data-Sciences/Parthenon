...
1. **Hive readiness probe** — short audit doc `docs/lineage/modules/2026-XX-XX-hive-federated-status-probe.md`. If Hive's federated query layer is production-ready, integrate; if not, build the spike against the `FederatedQueryClient` stub.
