...
**Context:** See `parthenon/docs/lineage/design/specs/2026-05-08-ce-ee-fork-and-agplv3-relicense-design.md` §3.4.
...
EE drivers, multi-tenancy, FIPS, observability, operator skeleton — all deferred to Plan 04 in \`Acumenus-Data-Sciences/Parthenon\` repo at \`docs/lineage/plans/open/\`."
