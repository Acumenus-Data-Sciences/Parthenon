...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-0-security.md`
...
```bash
cd /home/smudoshi/Github/Parthenon
git add docs/lineage/modules/ingestion/templates-phase-0-security.md
...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-0-dod.md`
...
**Spec:** `docs/lineage/design/specs/2026-05-02-parthenon-ingestion-templates-phase-0-design.md` §9
...
- [ ] `load_athena_vocabulary` runs end-to-end against a real bundle in staging (user-initiated).
  Evidence: staging run-id _(fill)_, validation pack output committed at `docs/lineage/modules/ingestion/staging-runs/load_athena_vocabulary-<date>.md`
...
- [ ] HIGHSEC §8 review passes.
  Evidence: `docs/lineage/modules/ingestion/templates-phase-0-security.md` signed off.
...
- [ ] Devlog written.
  Evidence: `docs/lineage/modules/ingestion/templates-phase-0.md` (Task 19 below).

- [ ] Operations runbook written.
  Evidence: `docs/lineage/modules/ingestion/templates-phase-0-runbook.md` (Task 20 below).
...
```bash
cd /home/smudoshi/Github/Parthenon
git add docs/lineage/modules/ingestion/templates-phase-0-dod.md
...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-0.md`
...
```bash
cd /home/smudoshi/Github/Parthenon
git add docs/lineage/modules/ingestion/templates-phase-0.md
...
**Files:**
- Create: `/home/smudoshi/Github/Parthenon/docs/lineage/modules/ingestion/templates-phase-0-runbook.md`
...
echo "Run ID: $TEMPLATE_RUN_ID, Date: $(date), Duration: ..." \\
  > docs/lineage/modules/ingestion/staging-runs/load_athena_vocabulary-$(date +%Y-%m-%d).md
```
...
```bash
cd /home/smudoshi/Github/Parthenon
git add docs/lineage/modules/ingestion/templates-phase-0-runbook.md
...
Edit `docs/lineage/modules/ingestion/templates-phase-0-dod.md`:
...
```bash
cd /home/smudoshi/Github/Parthenon
git add docs/lineage/modules/ingestion/
...
- docs/lineage/modules/ingestion/templates-phase-0.md
- docs/lineage/modules/ingestion/templates-phase-0-dod.md
- docs/lineage/modules/ingestion/templates-phase-0-security.md
...
> `load_synpuf`. Devlog: docs/lineage/modules/ingestion/templates-phase-0.md.
