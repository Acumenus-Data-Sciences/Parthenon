...
**Files:**
- Create: `docs/lineage/modules/finngen/sp2-code-explorer.md`
- Modify: `docs/lineage/modules/finngen/runbook.md`

- [ ] **Step 1: Write the devlog**

```bash
cat > docs/lineage/modules/finngen/sp2-code-explorer.md << 'EOF'
...
Append to `docs/lineage/modules/finngen/runbook.md`:

```bash
cat >> docs/lineage/modules/finngen/runbook.md << 'EOF'
...
```bash
git add docs/lineage/modules/finngen/sp2-code-explorer.md docs/lineage/modules/finngen/runbook.md
...
```bash
cat > docs/lineage/modules/finngen/sp2-pre-merge-verification.md << 'EOF'
...
```bash
git add docs/lineage/modules/finngen/sp2-pre-merge-verification.md
