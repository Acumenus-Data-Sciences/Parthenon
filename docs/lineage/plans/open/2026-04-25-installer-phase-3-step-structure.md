...
**Spec reference:** `docs/lineage/design/specs/2026-04-24-installer-first-run-comprehensive-design.md` — Block 3 (step structure) + Area C1, C2, C3, C4. Verify step gates on Phase 1's `health` contract action (Area A3).
