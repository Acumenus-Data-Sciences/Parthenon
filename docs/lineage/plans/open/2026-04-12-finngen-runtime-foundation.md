...
**SP2–4 handoff:** `docs/lineage/design/specs/2026-04-12-finngen-workbench-subprojects-handoff.md`
...
**Files:**
- `docs/lineage/modules/finngen/sp1-runtime-foundation.md`
- `docs/lineage/modules/finngen/runbook.md`
...
```bash
git add docs/lineage/modules/finngen
