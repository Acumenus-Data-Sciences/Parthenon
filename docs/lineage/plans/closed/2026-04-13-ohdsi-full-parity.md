...
lineage_anchor: true
supersedes: []
superseded_by: docs/lineage/modules/analyses/2026-04-15-ohdsi-full-parity-shiny-supersession-runtime-guardrails.md
related_code: []
related_prs: []
---
...
- [x] Document them as intentionally replaced by Parthenon's native React surfaces in `docs/lineage/design/specs/2026-04-15-ohdsi-shiny-supersession-policy.md`.
