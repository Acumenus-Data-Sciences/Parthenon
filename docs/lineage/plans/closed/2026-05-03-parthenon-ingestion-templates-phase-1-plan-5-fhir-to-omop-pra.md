...
Append a section to the templates devlog (`docs/lineage/modules/templates-laravel-integration-2026-05-02.md`) documenting the new migration:
...
git add templates/runtime/fhir_to_omop/unmapped_queue.py \
        templates/tests/unit/test_unmapped_queue.py \
        backend/database/migrations/2026_05_03_120000_create_unmapped_concepts_queue_table.php \
        docs/lineage/modules/templates-laravel-integration-2026-05-02.md
