...
**Files:**
- Create: `docs/lineage/modules/patient-profiles/2026-04-09-labs-trend-chart-shipped.md`
...
```bash
git add docs/lineage/modules/patient-profiles/2026-04-09-labs-trend-chart-shipped.md
