...
lineage_anchor: true
supersedes: []
superseded_by: docs/lineage/design/architecture/extension-points.md
related_code: []
related_prs: []
---
...
**Spec reference:** [docs/lineage/design/specs/2026-05-08-ce-ee-fork-and-agplv3-relicense-design.md](../../design/specs/2026-05-08-ce-ee-fork-and-agplv3-relicense-design.md) §5 (CE Extension Points) and §7 Phase 2.
...
3. I'll write the detailed sub-plan (`docs/lineage/plans/open/2026-05-XX-ce-ee-fork-plan-02-NN-<feature>.md`) with full TDD tasks.
