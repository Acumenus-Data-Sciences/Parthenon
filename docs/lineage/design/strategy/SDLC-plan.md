...
# Create a devlog: docs/lineage/modules/{module}/{topic}.md
...
4. Create release: `gh release create v1.0.X --title "..." --notes-file docs/lineage/timeline/releases/vX.Y.Z-release-notes.md`
...
```
1. DEVLOG
   Update or create docs/lineage/modules/{module}/{topic}.md
