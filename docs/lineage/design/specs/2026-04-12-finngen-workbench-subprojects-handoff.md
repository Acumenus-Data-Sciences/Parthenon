...
Summarized from the deep assessment completed 2026-04-12 (see `docs/lineage/modules/finngen/` for the raw report). Treat these as invariants; all downstream design must match upstream intent, not reinvent it.
...
5. The spec lives under `docs/lineage/design/specs/YYYY-MM-DD-finngen-<sp-name>-design.md`
