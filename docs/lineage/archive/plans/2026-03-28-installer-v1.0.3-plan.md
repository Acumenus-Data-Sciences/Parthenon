...
**Files:**
- Create: `docs/lineage/timeline/releases/v1.0.3-release-notes.md`
...
Write `docs/lineage/timeline/releases/v1.0.3-release-notes.md`:
...
```bash
git add docs/lineage/timeline/releases/v1.0.3-release-notes.md
