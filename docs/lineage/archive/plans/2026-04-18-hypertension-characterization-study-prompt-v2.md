...
You are implementing an end-to-end observational hypertension characterization study inside the Parthenon platform. The study was authored by Glenn H. Bock, MD ("DRAFT: Characterization of hypertension in a large study population (V2)", 04/17/2026, imported 04/18/2026). Read `docs/lineage/modules/STUDIES.md`, `docs/lineage/modules/analyses/`, and `CLAUDE.md` before writing any code. Query the Parthenon Brain (`parthenon-brain` MCP, collections `parthenon_docs` and `parthenon_code`) for prior art on:
...
5. `docs/lineage/modules/studies/2026-04-17-htn-characterization-implementation.md` — implementation devlog in the standard format.
