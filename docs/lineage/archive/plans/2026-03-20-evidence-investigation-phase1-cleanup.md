...
**Architecture:** Mostly frontend polish and small backend additions. The volcano plot and TimeCodeWAS are excluded — those require new Darkstar R endpoints (tracked in `docs/lineage/archive/plans/volcano-plot-darkstar-handoff.md`). The matching panel + love plot is deferred to Phase 4. This plan focuses on items that can be completed with existing backend infrastructure.

**Tech Stack:** React 19, TypeScript, D3 v7, Recharts v3, Laravel migrations, TanStack Query

**Spec:** `docs/lineage/design/specs/2026-03-20-finngen-evidence-investigation-design.md`
...
|------|--------|----------|
| Volcano plot (D3 + R endpoint + PHP controller) | Requires new Darkstar R code | `docs/lineage/archive/plans/volcano-plot-darkstar-handoff.md` |
