...
The research in [docs/research/omop-on-fhir-landscape-2026.md](/home/smudoshi/Github/Parthenon/docs/research/omop-on-fhir-landscape-2026.md) and the shipped FHIR sync implementation in [docs/lineage/modules/fhir/phase-16-fhir-incremental-sync.md](/home/smudoshi/Github/Parthenon/docs/lineage/modules/fhir/phase-16-fhir-incremental-sync.md) point to the same conclusion: **Parthenon should treat the first-party bulk-sync pipeline as the canonical production FHIR ingestion pathway**.
...
- The existing ingestion project model already unifies file upload and database-connection workflows:
  ...
  - [2026-03-26-ingestion-page-redesign.md](/home/smudoshi/Github/Parthenon/docs/lineage/design/specs/2026-03-26-ingestion-page-redesign.md)
...
- [2026-03-11-fhir-omop-ig-compliance-design.md](/home/smudoshi/Github/Parthenon/docs/lineage/archive/specs/2026-03-11-fhir-omop-ig-compliance-design.md)
