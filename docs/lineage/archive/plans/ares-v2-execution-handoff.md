...
1. **v2 Design Spec:** `docs/lineage/design/specs/2026-03-24-ares-v2-design.md` — 70 enhancements, data model, API, security
2. **v1 Design Spec:** `docs/lineage/design/specs/2026-03-24-ares-parity-design.md` — the foundation you're building on

### Plans (read these to understand HOW to build it)
3. **Phase A Plan:** `docs/lineage/plans/open/2026-03-24-ares-v2-phase-a.md` — 12 tasks, ~20 quick wins
4. **Phase B Plan:** `docs/lineage/plans/open/2026-03-24-ares-v2-phase-b.md` — 10 tasks, ~25 core transforms
5. **Phase C Plan:** `docs/lineage/plans/open/2026-03-24-ares-v2-phase-c.md` — 11 tasks, ~15 advanced + differentiators
...
1. **Devlog** — update `docs/lineage/modules/data-explorer/ares-v2-progress.md`
