...
- Phase 3 Plan 1 — `docs/lineage/plans/closed/2026-05-06-parthenon-ingestion-templates-phase-3-plan-1-x12-837.md`.
- ADR 0015 (`sql_file://` reader) — `docs/lineage/decisions/adr/adr-0015-sql-file-reader.md`.
- Phase 3 Plan 2 — `docs/lineage/plans/closed/2026-05-06-parthenon-ingestion-templates-phase-3-plan-2-x12-835.md`.
