...
### Docs
- `docs/lineage/timeline/phases/06-auth-admin.md` — this file
- `docs/lineage/design/strategy/PLAN.md` — Phase 6 updated; Phase 8 extensively rewritten
...
After the initial Phase 6 delivery, the full auth regime from `docs/lineage/design/architecture/authregime.md` was implemented. This adapts the Node.js/Express auth pattern from that document to Parthenon's Laravel/React stack. The core additions are:
