...
- [Phase 18]: [Phase 18-02] Pre-commit migration gate enforced — every backend/database/migrations/* commit now requires a paired docs/lineage/ or CHANGELOG entry. Created docs/lineage/modules/finngen/phase18-02-endpoint-profile-access-and-permissions.md as the pattern for future Phase 18 migrations
